...
public class NewMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String ruta = "C:\\Users\\Manu CG\\Downloads\\prueba.xml";
        ...
        for (Profesor p : profesores) {
            System.out.println("[profesor]:" + p.getNombre() + " [cp]:" + p.getCp() + " [Horas lectivas]:" + p.getHorasLectivas() + " [Mayor55]:" + p.isMayor55());
        }
        for (Alumno alu : alumnos) {
            System.out.println("[alumno]:" + alu.getNombre() + " [apellido]: " + alu.getApellido() + " [edad]:" + alu.getEdad() + " [notaMedia]: " + alu.getNotaMedia());
        }
    }
